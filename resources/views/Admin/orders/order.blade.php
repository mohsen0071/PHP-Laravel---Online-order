            ...
            <div class="col-lg-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class=""><a  href="/admin/clients/{{$user->id}}/edit"> <h3 class="m-b-none">پروفایل</h3></a></li>
                        @can('add-order-client')
                        <li class="active"><a  href="/admin/clients/{{$user->id}}/order"> <h3 class="m-b-none">ثبت سفارش</h3></a></li>
                        @endcan
                        ...
                        <div id="tab-1" class="tab-pane active">
                            <div class="panel-body">
                                <div class="ibox float-e-margins">
                                    <form action="{{ route('orders.store')}}" id="orderform"   method="post" enctype="multipart/form-data">                                    <div class="row">
                                            {{ csrf_field() }}
                                            <div class="col-lg-7">
                                            ...
                                            <input type="hidden" name="setDiscount" id="setDiscount" value="0">
