               ...
               <b>
                                  ...
                                  <span class="text-info"> {{$orders->order_number}} </span>
                                   ...
                                   عنوان سفارش :
                                    ...
                                    <a href="/admin/print/{{$orders->id}}" target="_blank" class="btn btn-success" style="float: left;">
<i class="fa fa-print"></i>
                ...
                <b>
                               ...
                               <span class="label label-info">{!! $client->user_type == 1 ? 'عادی' : 'همکار' !!}</span>
                                </p>
                                <p>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="alert alert-info">
                                   ...
                                   <h3>  <b> مبلغ سفارش : </b> {{ number_format($productPrice - $pservicePrice - $orders->price_design) }} </h3>
                                    <div class="hr-line-dashed"></div>
                                   <h3 class="text-green">  <b> مبلغ نهایی : </b> {{ number_format($productPrice) }} </h3>
                                </div>
                            </div>
                        </div>
                    </div>
