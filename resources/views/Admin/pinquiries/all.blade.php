...
@section('title', ' استعلام قیمت مشتری')
@section('content')
@section('style')
                                    ...
                                    @foreach($pinquiries as $pinquiry)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                ...
                                                <form action="{{ route('pinquiries.destroy'  , ['id' => $pinquiry->id]) }}" data-title="{{$pinquiry->id}}" method="post" class="text-left tooltip-demo frm{{$pinquiry->id}}">
                                                    {{ method_field('delete') }}
                                                    {{ csrf_field() }}
                                                    @can('answer-pinq')
                                                    <a href="{{ route('pinquiries.show' , ['id' => $pinquiry->id]) }}"  class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="top" title="" data-original-title="ارسال پاسخ ">
                                                        <i class="fa fa-mail-reply"></i>
                                                    </a>
                                                    @endcan
                                                    {{--<a href="{{ route('pinquiries.show' , ['id' => $pinquiry->id]) }}"  class="btn btn-info btn-xs btn-rounded" data-toggle="tooltip" data-placement="top" title="" data-original-title="بستن درخواست">--}}
