        ...
        <div class="col-lg-12">
            <div class="tabs-container">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a  href="/admin/clients/{{$client->id}}/client-cheques"> <h3 class="m-b-none">  چک ها و فیش ها </h3></a></li>
                                ...
                                <form action="" method="get">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <a href="/admin/clients/{{$client->id}}/client-cheques" class="btn btn-primary m-t-md">نمایش همه</a>
                                        </div>
                                    </div>
                                </form>
                                {{--<div class="row">--}}
